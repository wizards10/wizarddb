...
int ICommand::execute (_ossSocket& sock , std::vector<std::string>& argVec)
{
    return EDB_OK;
}
...
int ICommand::recvReply(_ossSocket& sock )
{
    int length = 0;
    int ret = EDB_OK;
...
int ICommand::sendOrder( _ossSocket& sock , int opCode)
{
   int ret = EDB_OK;
...
/*********************************ConnectCommand***************************/
int ConnectCommand::execute(_ossSocket& sock , std::vector<std::string>& argVec)
{
   int rc = EDB_OK;
   _address = argVec[0];
...
int QuitCommand::execute(_ossSocket& sock , std::vector<std::string>& argVec)
{
   int ret = EDB_OK;
   if(!sock.isConnected())
   {
...
/*************************************HelpCommand**************************************/
int HelpCommand::execute(_ossSocket& sock , std::vector<std::string>& argVec)
{
   int ret = EDB_OK;
