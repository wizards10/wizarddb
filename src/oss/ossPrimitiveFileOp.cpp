...
void ossPrimitiveFileOp::openStout()
{
    setFileHandle(STDOUT_FILENO);
    _bIsStout = true;
}
offsetType ossPrimitiveFileOp::getCurrentOffest()const
{
...
void ossPrimitiveFileOp::seekToOffest(offsetType offset)
{
